...
pagmo::decision_vector optimiser::run_once(pagmo::decision_vector *single_obj_result, const bool print_fronts, double maxDeltaV, std::vector<std::string> algo_list) {
  ...
  // Single-obj
  algos_map["jde"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::jde(m_mf, 2, 1, 1e-1, 1e-2, true));
  algos_map["jde_11"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::jde(m_mf, 11, 2, 1e-1, 1e-2, true));
  algos_map["jde_13"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::jde(m_mf, 13, 2, 1e-1, 1e-2, true));
  algos_map["jde_15"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::jde(m_mf, 15, 2, 1e-1, 1e-2, true));
  algos_map["jde_17"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::jde(m_mf, 17, 2, 1e-1, 1e-2, true));
  algos_map["de_1220"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::de_1220(m_mf));
  algos_map["mde_pbx"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::mde_pbx(m_mf));
  algos_map["pso"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::pso(m_mf));
  algos_map["bee_colony"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::bee_colony(m_mf));
  algos_map["cmaes"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::cmaes(m_mf));
  algos_map["sga_gray"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::sga_gray(m_mf));
  algos_map["sa_corana"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::sa_corana(m_mf * 100));

  // Multi-obj
  algos_map["nsga2"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::nsga2(m_mf));

  // Meta-algorithm
  
  // Local optimizers
  algos_map["cs"] = std::auto_ptr<pagmo::algorithm::base>(new pagmo::algorithm::cs(m_mf));
